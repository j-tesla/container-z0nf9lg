...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-z0nf9lg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-z0nf9lg.containers.anotherwebservice.com/
...
```
git clone git@github.com:j-tesla/container-z0nf9lg.git
cd container-z0nf9lg
```
...
```
docker attach container-z0nf9lg
```
